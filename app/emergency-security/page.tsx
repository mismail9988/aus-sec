    ...
    <>
      <section className="bg-[#c8102e] py-20 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4">
            <a href="mailto:info@securityguardcompanymelbourne.com" className="inline-flex items-center gap-3 bg-white text-[#c8102e] font-black px-8 py-4 text-lg uppercase tracking-wide hover:bg-gray-100 transition-colors">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
            ...
            <div>
              <div className="bg-[#c8102e] p-8 mb-6">
                ...
                <a href="mailto:info@securityguardcompanymelbourne.com" className="block text-white font-black text-xl mb-6 hover:underline break-all">info@securityguardcompanymelbourne.com</a>
      ...
      <section className="bg-[#1a1a2e] py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
          <div>
            <h2 className="text-3xl font-black text-white uppercase mb-2">Security Emergency? Contact Us Now.</h2>
            <p className="text-gray-400">Our operations centre is staffed 24/7. We respond immediately.</p>
          </div>
          <a href="mailto:info@securityguardcompanymelbourne.com" className="shrink-0 bg-[#c8102e] text-white font-black px-8 py-4 text-sm uppercase tracking-wide hover:bg-[#a00d25] transition-colors">
            Email Us Now
          </a>
        </div>
      </section>
